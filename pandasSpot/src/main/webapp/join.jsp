			...
			<div>
				<div>
					<form action="Join" method="post" enctype="multipart/form-data" onsubmit="return validateForm()">
						...
						<div class="join-input message" id="name_message"></div> 
						...
						<div class="join-input message" id="id_check_message"></div>
						...
						<div class="join-input message" id="nick_message"></div>
						<input class="join-input" type="date" id="mem_birthdate" name="mem_birthdate"> 
						<div class="join-input message" id="birth_message"></div>
						...
						<div class="join-input message" id="school_message"></div>
