...
<div class="container">
  <div class="panel panel-default">
    <div class="panel-heading" align="center"><h3>공부 기록</h3></div>
    	...
    	<div class="form-horizontal">	
		    ...
		    <div class="form-group">
		      <div style="width: 80%; max-width: 500px; min-height: 200px; margin: 0 auto; background-color: lightgrey; padding: 20px;">
 				<span>레코드 사진 들어갈 공간</span>
				</div>
		      </div>
		    </div>
		    <!-- 댓글 부분 -->
			<div class="form-group">
   				 <div style="width: 80%; max-width: 500px; min-height: 30px; margin: 0 auto; background-color: white; display: flex; justify-content: space-between;">
   				 <span>태그 불러올 공간</span>
   				 <div>좋아요(int)</div>
			</div>    
