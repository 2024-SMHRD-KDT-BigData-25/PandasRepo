...
<body>
	<%@ include file="header.jsp"%>
		...
		<div>
			<h2 class="post-title">자유게시판</h2>
			<div>
				<form action="CommunityPost">
				<div class="post-display-block">
					<label class="image_label" for="subject">제목</label> 
					<input class="post_text_input post-input" type="subject" id="subject" name="comm_title">
				</div>
				<div class="content_textarea_div">
					<label class="image_label" for="post_textarea">내용</label>
					<textarea class="post_text_input" name="comm_content" id="post_textarea" cols="30"
						rows="13" class="post-input" placeholder="내용 입력"></textarea>
				</div>
				...
				<label> <img src="icon/add (1).png" alt="이미지 추가하기"
					...
					id="mem_profile_img" name="comm_file">
				</label>
