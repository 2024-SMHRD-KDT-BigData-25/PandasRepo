				...
				<form action="CommunityPost">
					...
					<tr><td colspan="2" id="post_title_td"><h2 class="post-title">자유게시판</h2></td></tr>
						...
						<tr>
							...
							<td class="td_right"><textarea class="post_text_input" name="comm_content" id="post_textarea" cols="15" rows="13" class="post-input" placeholder="내용 입력" required></textarea>
							</td>
						</tr>
						<tr>
							<td class="td_left">
