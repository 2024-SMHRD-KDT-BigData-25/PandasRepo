...
<div class="container">
  <div class="panel panel-default">
    <div class="panel-heading" align="center"><h3>Q & A</h3></div>
    <div class="panel-body">
    	<div class="form-horizontal">	
		    ...
		    <div style="width: 80%; max-width: 500px; display: flex; content:left ; margin: 0 auto; margin-bottom: 10px;">
		    	<span>문제집 : 문제집이름</span>
		    </div>
		    <div class="form-group">
		      <div style="width: 80%; max-width: 500px; min-height: 200px; margin: 0 auto; background-color: lightgrey; padding: 20px;">
 				<span>QnA 글 내용 들어갈 공간</span><br> 				
				</div>
		      </div>
		    </div>
		    <!-- 댓글 부분 -->
