...
/**
 * Servlet implementation class friendUnfollow
 */
@WebServlet("/friendUnfollow")
public class friendUnfollow extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		List<String> res = dao.friendUnfollow(new Followings(follower_id, following_id));
